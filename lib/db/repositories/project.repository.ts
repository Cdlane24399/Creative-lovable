  ...
  async update(
    ...
    try {
      ...
      if (data.screenshot_base64 !== undefined)
        updateData.screenshot_base64 = data.screenshot_base64;
      if (data.screenshot_url !== undefined)
        updateData.screenshot_url = data.screenshot_url;
      if (data.sandbox_id !== undefined)
        updateData.sandbox_id = data.sandbox_id;
      if (data.sandbox_url !== undefined)
        updateData.sandbox_url = data.sandbox_url;
      if (data.files_snapshot !== undefined)
        updateData.files_snapshot = data.files_snapshot;
