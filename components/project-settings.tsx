...
import { Globe, Lock, Plus, Trash2, Save, Terminal, Activity, Server, Cpu } from "lucide-react"
    ...
    <div className="h-full w-full bg-[#111111] overflow-y-auto">
      <div className="max-w-4xl mx-auto p-8 space-y-10">
        ...
        <div>
          ...
          <p className="text-zinc-400 mt-1">Manage configuration, deployments, and AI options for {project?.name || "your project"}</p>
        </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
            ...
            <h2 className="text-lg font-semibold text-zinc-200">Visibility & Access</h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <Globe className={cn("h-4 w-4", visibility === "public" ? "text-blue-400" : "text-zinc-400")} />
                <span className={cn("font-medium", visibility === "public" ? "text-blue-100" : "text-zinc-300")}>Public</span>
              </div>
              <p className="text-xs text-zinc-500">Anyone with the link can view your deployed project.</p>
            </button>
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <Lock className={cn("h-4 w-4", visibility === "private" ? "text-amber-400" : "text-zinc-400")} />
                <span className={cn("font-medium", visibility === "private" ? "text-amber-100" : "text-zinc-300")}>Private</span>
              </div>
              <p className="text-xs text-zinc-500">Only you can view and edit this project.</p>
            </button>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
            ...
            <h2 className="text-lg font-semibold text-zinc-200">Environment Variables</h2>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
            ...
            <h2 className="text-lg font-semibold text-zinc-200">AI Configuration</h2>
          </div>
          ...
          <div className="bg-zinc-900/30 rounded-xl border border-zinc-800 p-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-zinc-400">Custom System Prompt</label>
                <textarea 
                  rows={3}
        ...
        <section className="space-y-4">
          ...
          <div className="bg-zinc-900/30 rounded-xl border border-zinc-800 overflow-hidden">
            ...
            <div className="divide-y divide-zinc-800/50">
              {[
                { message: "Update landing page hero", status: "ready", time: "2m ago" },
                { message: "Fix mobile navigation", status: "ready", time: "1h ago" },
                { message: "Initial commit", status: "ready", time: "3h ago" },
              ].map((deploy, i) => (
                <div key={i} className="grid grid-cols-[1fr_auto_auto] gap-4 p-4 text-sm hover:bg-zinc-800/20 transition-colors">
                  <div className="flex items-center gap-2">
                    <div className="h-2 w-2 rounded-full bg-emerald-500" />
                    <span className="text-zinc-300 font-mono">{deploy.message}</span>
                  </div>
