                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="start" className="w-[200px] bg-[#1A1A1A] border-zinc-800 p-1">
                                {Object.entries(MODEL_DISPLAY_NAMES).map(([key, name]) => (
                                    ...
                                    >
                                        <ModelIcon model={key as ModelProvider} className="h-3.5 w-3.5" />
                                        {name}
                                    </DropdownMenuItem>
                                ))}
                            </DropdownMenuContent>
...
function ModelIcon({ model, className }: { model: ModelProvider; className?: string }) {
    if (model.includes("anthropic") || model === "opus") return <AnthropicIcon className={className} />
